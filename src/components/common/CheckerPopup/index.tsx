        ...
        <>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              ...
              <div className="bg-white/5 rounded-lg p-4">
                <p className="text-white/60 text-sm">Favorite Species</p>
                <p className="text-xl font-medium">{data.favoriteSpecies}</p>
              </div>
              <div className="bg-white/5 rounded-lg p-4">
                <p className="text-white/60 text-sm">NANA Points</p>
            ...
            <div className="mb-6">
              <div className="flex justify-between mb-2">
                ...
                <span className="text-white/60">{data.progress}/19</span>
              </div>
              <div className="h-2 bg-white/10 rounded-full overflow-hidden">
                <div
                  className={`h-full ${data.isEligible ? 'bg-green-500' : 'bg-red-500'} 
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {data.missingSpecies.map((species) => (
                    <div
                      key={species}
                      className="bg-white/5 rounded-lg px-3 py-2 text-sm text-white/80"
                    >
                      {species}
                    </div>
                  ))}
