        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-5">
          ...
          {Object.entries({
            ...
            <div key={title} className="col-span-1">
              <h6 className="text-transparent bg-clip-text bg-gradient-to-b from-white/30 to-white mb-4 text-lg font-normal">
                {title}
              </h6>
          ...
          <div className="flex gap-3">
            {[
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-white transition-transform duration-300 hover:translate-y-[-2px]"
              >
                <Icon />
              </a>
            ))}
